...
"""
Script adopted from examples/atorch_trainer_v2 to accomodate local sgd patched megatron training
"""
...
# NOTE megatron training args can be read as normal cmd line args
# because in atorch megatron wrapper's initialize_megatron
# megatron's parse_args is called
# to enable local sgd argument readin, we can simply provider extra_args_provider
...
def train_valid_test_datasets_provider(train_val_test_num_samples):
    ...
    def core_gpt_dataset_config_from_args(args):
        ...
        return GPTDatasetConfig(
            ...
            blend=get_blend_from_list(args.data_path),  # NOTE 0.7.0 compatibility
            blend_per_split=[
            ...
            # mock=args.mock_data, # TODO verify why is this causing trouble
...
def main():
    ...
    # These extra args will be handled and inserted into MegatronArgs with the help of do_auto_mapping
