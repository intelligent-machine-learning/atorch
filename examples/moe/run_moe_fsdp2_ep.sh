...
STRATEGY_LIST="--use_fsdp2 --use_amp --use_module_replace --use_checkpointing --moe_implementation_type MegaBlocks --moe_token_dispatcher_type AllToAll"

# comment it when use --open_fsdp2_prefetch
export CLOSE_FSDP2_BACKWARD_PREFETCH=True
